...
const list = document.getElementById("list");       // 항목 가져오기
const createBtn = document.getElementById("create-btn");

let todos = [];     // todo 리스트 배열 안에 넣기

createBtn.addEventListener('click', createNewTodo);    // addEventListener  => 어떠한 이벤트가 발생했을 때 함수를 등록.
